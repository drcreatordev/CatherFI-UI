...
Folder ini berisi versi lama **CatherFIUI.lua** (API v1 `CreateWindow`/`CreateTab`).

**Status:** `DEPRECATED` — dipindah kesini biar root rapi & gak duplikat dengan `CatherFI.lua` v2 full original.

- `CatherFIUI.lua` — 976 lines, v1 lama, jangan pakai untuk project baru
