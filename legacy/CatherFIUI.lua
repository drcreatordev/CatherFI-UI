...
local function Stroke(parent, color, thickness)
    ...
    s.Color = color or CatherFIUI.Theme.ElementStroke
...
function CatherFIUI:Notify(cfg)
    cfg = cfg or {}
    ...
    holder.BackgroundColor3 = CatherFIUI.Theme.Element
    holder.Position = UDim2.new(1, -320, 1, -20)
    holder.AnchorPoint = Vector2.new(0,1)
    holder.Parent = gui
    Corner(holder, 10)
    Stroke(holder, CatherFIUI.Theme.ElementStroke, 1)
    ...
    tLabel.TextSize = 14
    tLabel.TextColor3 = CatherFIUI.Theme.Text
    ...
    cLabel.TextSize = 12
    cLabel.TextColor3 = CatherFIUI.Theme.SubText
...
function CatherFIUI:CreateWindow(settings)
    settings = settings or {}
    local winName = settings.Name or "CatherFI Hub"
    local loadingTitle = settings.LoadingTitle or "CatherFI UI"
    ...
    local keySettings = settings.KeySettings or {Key={"CatherFI"}, FileName="CatherFIKey", SaveKey=false}
    ...
    ScreenGui.Name = "CatherFIUI_"..tostring(math.random(1000,9999))
    ...
    LoadingFrame.BackgroundColor3 = CatherFIUI.Theme.Background
    Corner(LoadingFrame, 12)
    Stroke(LoadingFrame, CatherFIUI.Theme.ElementStroke,1)
    local lTitle = Instance.new("TextLabel", LoadingFrame)
    lTitle.Text = loadingTitle
    lTitle.Font = Enum.Font.GothamBold
    lTitle.TextSize = 18
    lTitle.TextColor3 = CatherFIUI.Theme.Text
    ...
    lSub.TextSize = 13
    lSub.TextColor3 = CatherFIUI.Theme.SubText
    ...
    barBG.BackgroundColor3 = CatherFIUI.Theme.Element
    Corner(barBG, 99)
    local bar = Instance.new("Frame", barBG)
    bar.Size = UDim2.new(0,0,1,0)
    bar.BackgroundColor3 = CatherFIUI.Theme.Accent
    Corner(bar, 99)
    ...
    MainFrame.BackgroundColor3 = CatherFIUI.Theme.Background
    MainFrame.Visible = false
    Corner(MainFrame, 12)
    Stroke(MainFrame, CatherFIUI.Theme.ElementStroke, 1)
    ...
    AccentLine.BackgroundColor3 = CatherFIUI.Theme.Accent
    Corner(AccentLine, 99)
    local grad = Instance.new("UIGradient", AccentLine)
    grad.Color = ColorSequence.new{CatherFIUI.Theme.Accent, CatherFIUI.Theme.Accent2}
    grad.Rotation = 90

    -- Topbar
    local Topbar = Instance.new("Frame", MainFrame)
    Topbar.Size = UDim2.new(1,0,0,45)
    Topbar.BackgroundColor3 = CatherFIUI.Theme.Topbar
    Corner(Topbar, 12)
    local fix = Instance.new("Frame", Topbar)
    fix.Size = UDim2.new(1,0,0,12)
    fix.Position = UDim2.new(0,0,1,-12)
    fix.BackgroundColor3 = CatherFIUI.Theme.Topbar
    ...
    Title.TextSize = 15
    Title.TextColor3 = CatherFIUI.Theme.Text
    ...
    MinBtn.BackgroundColor3 = CatherFIUI.Theme.Element
    MinBtn.Text = "—"
    MinBtn.Font = Enum.Font.GothamBold
    MinBtn.TextSize = 14
    MinBtn.TextColor3 = CatherFIUI.Theme.Text
    Corner(MinBtn, 8)
    Stroke(MinBtn, CatherFIUI.Theme.ElementStroke,1)

    -- Sidebar
    local Sidebar = Instance.new("Frame", MainFrame)
    Sidebar.Size = UDim2.new(0, 150, 1, -45)
    Sidebar.Position = UDim2.new(0,0,0,45)
    Sidebar.BackgroundColor3 = CatherFIUI.Theme.Sidebar
    Corner(Sidebar, 12)
    local sFix = Instance.new("Frame", Sidebar)
    sFix.Size = UDim2.new(1,0,0,12)
    sFix.Position = UDim2.new(0,0,0,0)
    sFix.BackgroundColor3 = CatherFIUI.Theme.Sidebar
    ...
    sFix2.BackgroundColor3 = CatherFIUI.Theme.Sidebar
    ...
    if keySystem then
        ...
        KeyFrame.BackgroundColor3 = CatherFIUI.Theme.Background
        KeyFrame.ZIndex = 10
        Corner(KeyFrame,12)
        ...
        kTitle.TextSize = 20
        kTitle.TextColor3 = CatherFIUI.Theme.Text
        ...
        kSub.TextSize = 13
        kSub.TextColor3 = CatherFIUI.Theme.SubText
        ...
        kNote.TextSize = 12
        kNote.TextColor3 = CatherFIUI.Theme.SubText
        ...
        KeyBox.BackgroundColor3 = CatherFIUI.Theme.Element
        KeyBox.PlaceholderText = "Enter Key..."
        KeyBox.Text = ""
        KeyBox.Font = Enum.Font.Gotham
        KeyBox.TextSize = 13
        KeyBox.TextColor3 = CatherFIUI.Theme.Text
        Corner(KeyBox,8)
        Stroke(KeyBox, CatherFIUI.Theme.ElementStroke,1)
        ...
        Submit.BackgroundColor3 = CatherFIUI.Theme.Accent
        Submit.Text = "Submit"
        ...
        Submit.MouseButton1Click:Connect(function()
            if CheckKey(KeyBox.Text) then
                ...
                CatherFIUI:Notify({Title="Key Correct", Content="Welcome!", Duration=2})
                Tween(KeyFrame, {BackgroundTransparency=1}, 0.3)
                task.wait(0.3)
                KeyFrame:Destroy()
                KeyFrame = nil
            else
                CatherFIUI:Notify({Title="Invalid Key", Content="Key salah!", Duration=2})
                Tween(KeyBox, {BackgroundColor3=Color3.fromRGB(80,30,30)},0.2)
                task.wait(0.5)
                Tween(KeyBox, {BackgroundColor3=CatherFIUI.Theme.Element},0.2)
            end
        end)
    end
    ...
    function Window:CreateTab(name, iconId)
        ...
        TabButton.BackgroundColor3 = CatherFIUI.Theme.Element
        ...
        Icon.ImageColor3 = CatherFIUI.Theme.SubText

        local Txt = Instance.new("TextLabel", TabButton)
        Txt.Text = name
        Txt.Font = Enum.Font.GothamMedium
        Txt.TextSize = 13
        Txt.TextColor3 = CatherFIUI.Theme.SubText
        ...
        TabPage.ScrollBarImageColor3 = CatherFIUI.Theme.Accent
        ...
        local function Select()
            for _,t in ipairs(Window.Tabs) do
                ...
                Tween(t.Button, {BackgroundColor3=CatherFIUI.Theme.Element},0.2)
                t.Button.BackgroundTransparency = 1
                t.Button:FindFirstChildOfClass("TextLabel").TextColor3 = CatherFIUI.Theme.SubText
                t.Button:FindFirstChildOfClass("ImageLabel").ImageColor3 = CatherFIUI.Theme.SubText
            end
            TabPage.Visible = true
            TabButton.BackgroundTransparency = 0
            Tween(TabButton, {BackgroundColor3=CatherFIUI.Theme.Element},0.2)
            Txt.TextColor3 = CatherFIUI.Theme.Text
            Icon.ImageColor3 = CatherFIUI.Theme.Accent
        ...
        function Tab:CreateSection(secName)
            ...
            L.TextSize = 13
            L.TextColor3 = CatherFIUI.Theme.Text
            ...
            Line.BackgroundColor3 = CatherFIUI.Theme.ElementStroke
        ...
        function Tab:CreateLabel(text)
            ...
            F.BackgroundColor3 = CatherFIUI.Theme.Element
            Corner(F,8); Stroke(F)
            local LB = Instance.new("TextLabel", F)
            LB.Text = text
            LB.Font = Enum.Font.Gotham
            LB.TextSize = 13
            LB.TextColor3 = CatherFIUI.Theme.Text
        ...
        function Tab:CreateParagraph(cfg)
            ...
            Content.TextSize = 12
            Content.TextColor3 = CatherFIUI.Theme.SubText
        ...
        function Tab:CreateButton(cfg)
            ...
            Btn.BackgroundColor3 = CatherFIUI.Theme.Element
            Btn.Text = ""
            ...
            Ico.ImageColor3 = CatherFIUI.Theme.SubText
            Btn.MouseEnter:Connect(function() Tween(Btn,{BackgroundColor3=Color3.fromRGB(34,34,40)},0.2) end)
            Btn.MouseLeave:Connect(function() Tween(Btn,{BackgroundColor3=CatherFIUI.Theme.Element},0.2) end)
            Btn.MouseButton1Click:Connect(function()
                Tween(Btn,{BackgroundColor3=CatherFIUI.Theme.Accent},0.1)
                task.wait(0.1)
                Tween(Btn,{BackgroundColor3=CatherFIUI.Theme.Element},0.2)
                pcall(cfg.Callback)
            end)
            return {Set=function(_,t) LB.Text=t end}
        end
        ...
        function Tab:CreateToggle(cfg)
            ...
            if flag then CatherFIUI.Flags[flag]=val end
            local F = Instance.new("Frame", TabPage)
            ...
            SwitchBG.BackgroundColor3 = val and CatherFIUI.Theme.Accent or Color3.fromRGB(45,45,52)
            Corner(SwitchBG,99)
            ...
            local function Set(v)
                val=v
                if flag then CatherFIUI.Flags[flag]=v end
                Tween(SwitchBG,{BackgroundColor3 = v and CatherFIUI.Theme.Accent or Color3.fromRGB(45,45,52)},0.2)
                Tween(Dot,{Position = v and UDim2.new(1,-20,0.5,-9) or UDim2.new(0,3,0.5,-9)},0.2)
                if configSaving.Enabled and flag then SaveConfig(configSaving.FolderName or "CatherFIUI", configSaving.FileName or "config", CatherFIUI.Flags) end
            ...
            if configSaving.Enabled and flag then
                local data=LoadConfig(configSaving.FolderName or "CatherFIUI", configSaving.FileName or "config")
        ...
        function Tab:CreateSlider(cfg)
            ...
            ValLB.TextSize = 12
            ValLB.TextColor3 = CatherFIUI.Theme.Accent
            ...
            Fill.BackgroundColor3 = CatherFIUI.Theme.Accent
            Corner(Fill,99)
        ...
        function Tab:CreateDropdown(cfg)
            ...
            if flag then CatherFIUI.Flags[flag]= multi and cur or cur[1] end
            local F = Instance.new("Frame", TabPage)
            F.Size = UDim2.new(1,0,0,38)
            F.BackgroundColor3 = CatherFIUI.Theme.Element
            ...
            Disp.TextSize = 12
            Disp.TextColor3 = CatherFIUI.Theme.SubText
            ...
            Arrow.Rotation = 90
            Arrow.ImageColor3 = CatherFIUI.Theme.SubText
            local Btn = Instance.new("TextButton", F)
            ...
            for _,opt in ipairs(opts) do
                ...
                O.TextSize = 12
                O.TextColor3 = CatherFIUI.Theme.Text
                Corner(O,6)
                O.MouseButton1Click:Connect(function()
                    ...
                    for _,b in ipairs(List:GetChildren()) do if b:IsA("TextButton") then b.BackgroundColor3 = (table.find(cur,b.Text) and CatherFIUI.Theme.Accent or Color3.fromRGB(34,34,40)) end end
                end)
            end
            -- initial select colors
            task.defer(function()
                for _,b in ipairs(List:GetChildren()) do if b:IsA("TextButton") and table.find(cur,b.Text) then b.BackgroundColor3=CatherFIUI.Theme.Accent end end
            end)
        ...
        function Tab:CreateInput(cfg)
            ...
            Box.TextSize = 12
            Box.TextColor3 = CatherFIUI.Theme.Text
        ...
        function Tab:CreateColorPicker(cfg)
            ...
            if flag then CatherFIUI.Flags[flag]=col end
            local F = Instance.new("Frame", TabPage)
            F.Size = UDim2.new(1,0,0,38)
            F.BackgroundColor3 = CatherFIUI.Theme.Element
            Corner(F,8); Stroke(F)
        ...
        function Tab:CreateKeybind(cfg)
            ...
            if flag then CatherFIUI.Flags[flag]=cur end
            local F = Instance.new("Frame", TabPage)
            F.Size = UDim2.new(1,0,0,38)
            F.BackgroundColor3 = CatherFIUI.Theme.Element
            Corner(F,8); Stroke(F)
            ...
            KeyBtn.TextSize = 12
            KeyBtn.TextColor3 = CatherFIUI.Theme.Text
    ...
    function CatherFIUI:Destroy() ScreenGui:Destroy() end
